        ...
        {isMobile && (
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-blue-800 font-medium">
                  {isIOS ? 'iOS' : 'Mobile/Tablet'} Voice Chat
                </p>
                <p className="text-blue-700 text-sm mt-1">
                  {isIOS 
                    ? 'Voice chat will automatically restart after each interaction on iOS. Speak clearly and wait for the microphone to reactivate.'
                    : 'Voice chat will listen continuously when activated. Speak clearly and the system will process your voice automatically after you finish speaking.'
                  }
                </p>
              </div>
            </div>
            ...
            {isMobile && (
              <>
                ...
                <div className="flex items-center space-x-2">
                  <Smartphone size={14} className="text-purple-600" />
                  <span className="text-sm font-medium text-purple-600">
                    {isIOS ? 'iOS Mode' : 'Mobile/Tablet Mode'}
                  </span>
                </div>
              </>
            )}
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-sm text-blue-700">
                ...
                {isIOS 
                  ? ' On iOS, it will automatically restart listening after each response.'
                  : ' It will listen continuously until you turn it off.'
                }
              </p>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-sm text-green-700">
                Speak clearly and include keywords like smoke, product, bot, or
                help in your questions. The system will automatically process your speech.
              </p>
            </div>
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Tip:</strong> For best results, speak in a quiet
              environment and wait for the AI to finish speaking before asking
              your next question. The system works continuously on both mobile and desktop.
            </p>
          </div>
        </div>
      </div>
